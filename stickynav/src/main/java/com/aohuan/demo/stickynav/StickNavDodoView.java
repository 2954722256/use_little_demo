 ...
 * 这个view基本完全参考鸿洋的实现
 *  也直接 拿的 https://github.com/r17171709/android_demo/tree/master/StickyNavLayout  对应的实现
 *  自己有时间再
 */
public class StickNavDodoView extends LinearLayout {
    ...
    public StickNavDodoView(Context context) {
        this(context, null);
    }

    public StickNavDodoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        id_bottomview = (AdapterView) findViewById(R.id.id_bottomview);
    }
