package com.aohuan.dodo.coordinator.doa.doa3;
...
public class MainA3Activity extends AppCompatActivity {
...
//                finish();
    ...
    private void init(ViewPager vp ) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_a3, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_main_a3, container, false);
