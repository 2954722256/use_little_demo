        ...
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            itemHolder.rootView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(RvS4Activity.this, String.format("Clicked on position #%s of Section %s", sectionAdapter.getSectionPosition(itemHolder.getAdapterPosition()), title), Toast.LENGTH_SHORT).show();
                }
            });
        }
