 ...
 *
 */
public class RvS1Activity extends AppCompatActivity {
    ...
    class ContactsSection extends StatelessSection {
        ...
        public ContactsSection(String title, List<String> list) {
            super(R.layout.item_section_ex1_header, R.layout.item_section_ex1_item);
        ...
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            itemHolder.rootView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(RvS1Activity.this, String.format("Clicked on position #%s of Section %s", sectionAdapter.getSectionPosition(itemHolder.getAdapterPosition()), title), Toast.LENGTH_SHORT).show();
                }
            });
        }
